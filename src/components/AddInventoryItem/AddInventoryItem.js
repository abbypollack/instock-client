...
function AddInventoryItemComponent() {
    ...
    useEffect(() => {
        // TODO: Fetch the list of warehouses and categories from the API
        // axios.get('/ENDPOINT').then(response => setWarehouses(response.data));
        //axios.get('/ENDPOINT').then(response => setCategories(response.data))
        ...
        <section className="add-inventory-item">
            ...
            <form className="add-inventory-item__form" onSubmit={handleSubmit} noValidate>
                <div className="add-inventory-item__details">
                    ...
                    <textarea
                        className="add-inventory-item__textarea"
                        id="description"
                ...
                <div className="add-inventory-item__availability">
                    ...
                    <div className="add-inventory-item__stock">
                        ...
                        <div className="add-inventory-item__radios">
                            <label className="add-inventory-item__label add-inventory-item__label--radio">
                                <input
                                    className="add-inventory-item__radio"
                                    type="radio"
                                    name="status"
                                    value="in stock"
                    ...
                    {formData.status === 'in stock' && (
                        <>
                            ...
                            <input
                                className="add-inventory-item__input add-inventory-item__input--quantity"
                                type="number"
                                id="quantity"
                                name="quantity"
                    ...
                    {errors.warehouse && <p className="add-inventory-item__error">{errors.warehouse}</p>}
                </div>
            </form>
